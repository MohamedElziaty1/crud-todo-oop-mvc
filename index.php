...
require_once('classes/todoView.php');
...
<h1 style="text-decoration: line-through; ">
  <input type="checkbox" checked disabled onclick="complete(this);" class="checkbox"
  id="<?php echo $todo['id']?>" />
...
<h1 >
  <input type="checkbox" onclick="complete(this);" class="checkbox"
  id="<?php echo $todo['id']?>" />
<?php echo $todo['todoName'];?>
